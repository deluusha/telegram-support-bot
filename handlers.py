...
def forward_to_user(update, context):
    """{
        ...
        'reply_to_message': {
            ...
            'chat': {'type': 'group', 'title': '☎️ Чат Поддержки', 'all_members_are_administrators': True}, 
            'forward_from': {'Имя': 'Daniil', 'Фамилия': 'Okhlopkov', 'danokhlopkov': 'okhlopkov'}, 
            ...
            'from': {'Имя': 'SUPPORT', 'Никнейм': 'lolkek'}
        }, 
